%% a1F4:此程序为调用的函数，为改进的线性权重粒子群 APSO 的算法
%{
...
Best_pos：全局最优粒子
Best_score：最好的得分
Convergence_curve：进化曲线
%}

%% 函数主体
function [Best_pos,Best_score,Convergence_curve] = a1F5(net)
...
if nargin == 1                                                                 % 确保函数的输入变量的个数为 4 个
    ...
    h0 = waitbar(0,'1','Name','APSO-ANN optimization...',...
