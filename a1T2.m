% a1T2:此程序的目的是画出已经训练好的预测值与真实值的对比图
...
a1 = output_testE1;                                                           % 列出 y2
a2 = output_testE2;                                                           % 列出 y3
a3 = output_testE3;                                                           % 列出 y4
...
f1s1 = scatter(xB,y1);                                                         % 画出真实值的散点图 f1s1
f1s1.Marker = 'o';                                                             % 散点类型
...
f1s2 = scatter(xB,y2);                                                         % 画出真实值的散点图 f1s1
f1s2.Marker = 'v';                                                             % 散点类型
...
f1s3 = scatter(xB,y3);                                                         % 画出真实值的散点图 f1s1
f1s3.Marker = '^';                                                             % 散点类型
...
f1s4 = scatter(xB,y4);                                                         % 画出真实值的散点图 f1s1
...
leg2 = legend('true','LPSO-ANN','APSO-ANN','DPSO-ANN');
leg2.FontSize = 14;
