...
%{
f2 = figure;
f2.Name  = '不同类型粒子群算法的迭代收敛曲线';                        % 图像的标题名称
hold on;
f2p0 = plot(ti,y0,'-r','Linewidth',1.8);                             % 画出线条L1

f2p11 = plot(ti,y21,'-b','Linewidth',1.8);                           % 画出线条L1
f2p12 = plot(ti,y22,'-m','Linewidth',1.8);                           % 画出线条L1
f2p13 = plot(ti,y23,'-k','Linewidth',1.8);                           % 画出线条L1
f2p14 = plot(ti,y24,'-c','Linewidth',1.8);                           % 画出线条L1
axis padded;    
xlabel('迭代次数');
ylabel('权值大小');
legend('1','2','3','4','5');
